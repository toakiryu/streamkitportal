    ...
    >
      ...
      {buttons?.customize && (
        <Link
          ...
          className="bg-indigo-600/90 text-white text-sm text-center font-normal flex justify-center items-center w-full mt-5 py-2 px-4 rounded-full transition-all duration-200 ease-in-out hover:opacity-70 hover:shadow-md active:scale-95"
        >
      ...
      {buttons?.website && (
        <div className="flex justify-center items-center mt-5 mx-auto">
          <Link
            ...
            className="text-indigo-600/90 text-sm font-normal no-underline hover:underline active:opacity-70"
          >
